...
# particular, we will be using the “Individual household electric power consumption Data Set” which I have made available on the course web
# site:
...
#########################################################################################################################################
# Plot1.R
# Construct Plot 1 shown here https://d396qusza40orc.cloudfront.net/exdata/CP1/ExDataCP1Plot1.png

# Set Current Working Directory to where the unzipped data file is. 
setwd("C:/Users/Patrick/Desktop/R Class/20150510")

# Get File handle to data file
fileh <- file("household_power_consumption.txt")

# Read data only for 1/2/2007 and 2/2/2007 dates.
data <- read.table(text = grep("^[1,2]/2/2007", readLines(fileh), value = TRUE), sep = ";", header = TRUE)
# Rename columns in tidy format
